...
# Function to generate PDF report using localStorage data
def generate_games_pdf_report(game_data):
    """Generate a PDF report for game results using Gemini API and ReportLab."""
...
def games_ui():
    ...
    if st.session_state.current_page == "main":
        ...
        # st.write("Current Game Data:", st.session_state.game_data)

        # if st.button("Generate Report"):
        #     pdf_buffer = generate_games_pdf_report(st.session_state.game_data)
        #     st.download_button(
        #         label="Download Games Report",
        #         data=pdf_buffer,
        #         file_name="autism_games_report.pdf",
    ...
    # Game pages
        ...
        #     fetch_result = st.components.v1.html(
        #         fetch_local_storage_data("emoji"),
        #         height=0
        #     )
        #     if isinstance(fetch_result, dict) and fetch_result.get("game") == "emoji":
        #         st.session_state.game_data["emoji_data"] = fetch_result["data"]
        #         st.write("Updated Emoji Data:", st.session_state.game_data["emoji_data"])
        ...
        # if st.button("Submit Result"):
        #     fetch_result = st.components.v1.html(
        #         fetch_local_storage_data("memory"),
        #         height=0
        #     )
        #     if isinstance(fetch_result, dict) and fetch_result.get("game") == "memory":
        #         st.session_state.game_data["memory_data"] = fetch_result["data"]
        #         st.write("Updated Memory Data:", st.session_state.game_data["memory_data"])
        ...
        # if st.button("Submit Result"):
        #     fetch_result = st.components.v1.html(
        #         fetch_local_storage_data("ball_clicker"),
        #         height=0
        #     )
        #     print("Fetch Result:", fetch_result)  # Debug output
        #     if isinstance(fetch_result, dict) and fetch_result.get("game") == "ball_clicker":
        #         st.session_state.game_data["ball_clicker_data"] = fetch_result["data"]
        #         st.write("Updated Ball Clicker Data:", st.session_state.game_data["ball_clicker_data"])
